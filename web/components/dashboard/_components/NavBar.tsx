...
export default function NavBar() {
  ...
  return (
    <div className={`navbar w-[100%] top-0 fixed  max-w-md w-[100%] flex justify-between px-[16px]`}>
          ...
          <button style={{zIndex:1}} className='border sm:ml-[00px] ml-[50px] border-[rgba(37,179,204)] border-[1px] py-[8px] px-[16px] rounded-[32px] h-[48px] bg-[#00000052]'>
            <p className='fontBold text-[22px] bold text-[#B8E6EE]'>267.3 M</p>
          </button>
          {publicKey? <div className="flex-none sm:mr-[20px] space-x-2 relative animate-slide-in-right">
           <div className='fontBold text-[17px] bold text-[#B8E6EE]'>Disconnect</div>
            <div className='opacity-0 scale-x-50 absolute'>
              <DisconnectButton />
            </div>
          </div> : <div className="flex-none space-x-2 sm:mr-[20px] relative animate-slide-in-right">
