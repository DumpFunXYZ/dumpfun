...
function Mockup() {
  return (
    <div className='w-screen bg-[#00191D]  flex items-center justify-center sm:px-[48px] px-[12px] min-h-screen flex-col'>
        ...
        style={{lineHeight:'32px'}} className='bg-[#42919E] my-[30px] rounded-[32px] min-h-[56px] w-[300px] flex items-center justify-center text-[#00191D] text-[22px] semiBold'>Join the Whitelist</button>
    </div>
